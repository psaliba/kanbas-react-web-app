        ...
        <div className="container-auto" >
            <div className="row">
                ...
                <div className="col-sm p-3 min-vh-100">
                    ...
                    <input value={course.startDate}className="form-control" onChange={(e) => setCourse({...course, startDate: e.target.value})} type="date"/>
                    <input value={course.endDate} className="form-control" onChange={(e) => setCourse({...course, endDate: e.target.value})} type="date"/>
                                                ...
                                                <div className="card"> <img src={`/images/${course.image}`} className="card-img-top" style={{ maxHeight: "150px" }} alt="" />
                                                    <div className="card-body">
                                                        ...
                                                        <div className="btn btn-danger" onClick={(e) => {
                                                            e.preventDefault();
                                                            deleteCourse(course._id)} }> Delete</div>
                                                    </div>
                                                </div>
                                            </Link>
                                        </div>
